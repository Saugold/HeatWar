...
public class BigEnemy : MonoBehaviour, IEnemy
{
    ...
    public void Morrer()
    {
        AudioManager._audioManager.PlayOneShot(FMODEvents._fmodEvents.sfxDeadBig, this.transform.position);
        Debug.Log("Morreu");
    ...
    IEnumerator ShootRoutine()
    {
        if (canAttack)
        {
            if (canShoot)
            {
                ...
                AudioManager._audioManager.PlayOneShot(FMODEvents._fmodEvents.sfxTiroBig, this.transform.position);
